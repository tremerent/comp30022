...
/* This page is intended to display details, comments and questions related to a particular artefact.
*/
...
export default Artefact =>
    <React.Fragment>
        ...
        <div class="container">
            ...
            <div class="col col-lg-8">
                ...
                <div class="card" style={style.Paper}>
                    ...
                    >
                        <div align="center">
                            <img src="https://source.unsplash.com/random" class="img-thumbnail" style={style2.artefactFrame} 
                            alt="Artefact"
                    ...
                    <div class="row">
                        <div class="col"><h3 class="text-left">Artefact Name</h3></div>
                    </div>
                    ...
                    >
                        ...
                        <div class="modal-content">
                            ...
                            {/* a badge to indicate that there is an image zoom functionality */}
                    ...
                    <div class="row" style={style.bio}>
                        <div class="col">
                            <p>Description of artefact. Category: <span class="m-1 badge badge-info">Vintage</span><span class="m-1 badge badge-success">Retro</span></p> 
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="card" style={style.Paper} >
                        ...
                        <div class="detailBox" id="accordion">
                            ...
                            <button class="btn btn-primary" style={{'margin-top': '30px'}} data-toggle="modal" data-target="#postQuestionModal">Ask your question</button>
                                
                    </div>
                    {/* modal for edit image. */}
                    <div class="modal fade" id="postQuestionModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            ...
                            <div class="actionBox">
                                <ul class="commentList">
                                    <li>
                                        ...
                                        {/* Text of comment including the time and date. */}
                                        <div class="commentText">
                                            <p class="">Comment 1.</p> <span class="date sub-text">on December 5th, 2014 at 3:00 PM</span>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="commenterImage">
                                        ...
                                        <div class="commentText">
                                            <p class="">Very very very very very very very very long comment.</p> <span class="date sub-text">on December 5th, 2014</span>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="commenterImage">
                                        ...
                                        <div class="commentText">
                                            <p class="">Quick comment.</p> <span class="date sub-text">on December 5th, 2014</span>
                                        </div>
                                    </li>
                                </ul>
        ...
        <script src="./ArtefactToBs.js"></script>
    </React.Fragment>